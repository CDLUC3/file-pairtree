...
#     PREREQ_PM => { Getopt::Long=>q[0], File::Glob=>q[0], Pod::Usage=>q[0], Carp=>q[0], File::Find=>q[0], File::Value=>q[0.20], File::Path=>q[0], File::Namaste=>q[0.20], File::OM=>q[0.21] }
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    File::Namaste:                 0.20' >> META_new.yml
	$(NOECHO) $(ECHO) '    File::OM:                      0.21' >> META_new.yml
	$(NOECHO) $(ECHO) '    File::Path:                    0' >> META_new.yml
	$(NOECHO) $(ECHO) '    File::Value:                   0.20' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="File-Namaste" VERSION="0,20,0,0" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="File-Value" VERSION="0,20,0,0" />' >> $(DISTNAME).ppd
